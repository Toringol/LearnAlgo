...
* значения. Сигналом к остановке должен служить тот факт, что все элементы
* массива L или массива R скопированы обратно в массив А, после чего в этот
* массив копируются элементы, оставшиеся в непустом массиве.
 */
